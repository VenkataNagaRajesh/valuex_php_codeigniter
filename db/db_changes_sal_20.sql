CREATE TABLE `VX_aln_daily_inv_feed_raw` (
  `invfeedraw_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `airline` varchar(60) NOT NULL,
  `flight_nbr` varchar(60) NOT NULL,
  `departure_date` varchar(60) NOT NULL,
  `origin_airport` varchar(60) NOT NULL,
  `dest_airport` varchar(60) NOT NULL,
  `cabin` varchar(60) NOT NULL,
  `empty_seats` varchar(60) NOT NULL,
  `sold_seats` varchar(60) NOT NULL,
  `active` tinyint(1) NOT NULL DEFAULT '1',
  `create_userID` int(11) NOT NULL,
  `modify_userID` int(11) NOT NULL,
  `create_date` int(11) NOT NULL,
  `modify_date` int(11) NOT NULL,
  PRIMARY KEY (`invfeedraw_id`),
  KEY `airline_indx` (`airline`),
...
ALTER  TABLE VX_aln_daily_inv_feed ADD COLUMN invfeedraw_id int(11) NOT NULL AFTER invfeed_id ;
