...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_add')?> <?=$this->lang->line('menu_eligibility_exclusion')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
...
<?php
			...
			foreach ($class_type as $class) {
				$class_list[$class->vx_aln_data_defnsID] = $class->aln_data_value;
                         ...
                         echo form_dropdown("upgrade_from_class_type", $class_list,set_value("upgrade_from_class_type"), "id='upgrade_from_class_type' class='form-control hide-dropdown-icon select2'");
     ...
     ?>                   </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
<?php
                         echo form_dropdown("upgrade_to_class_type", $class_list,set_value("upgrade_to_class_type"), "id='upgrade_to_class_type' class='form-control hide-dropdown-icon select2'");
