...
<?php
     ...
     ?> 
			...
			<input type="text" class="form-control" id="frequency" name="frequency" value="<?=set_value('frequency',$rule->frequency)?>" >		
                  </div>
                        <span class="col-sm-4 control-label">
...
$('#dest_level_id').trigger('change');
 ...
 var src_level = [<?php echo $rule->orig_level_value;?>];
$('#orig_level_value').val(src_level).trigger('change');
