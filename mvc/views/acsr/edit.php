...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_edit')?> <?=$this->lang->line('menu_acsr')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
        <div class="row">
			...
			ksort($marketzones);
                          echo form_dropdown("orig_market_id", $marketzones,set_value("orig_market_id",$rule->orig_market_id), "id='orig_market_id' class='form-control hide-dropdown-icon select2'");
                                                   ?>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
			<?php 
			  echo form_dropdown("dest_market_id", $marketzones,set_value("dest_market_id",$rule->dest_market_id), "id='dest_market_id' class='form-control hide-dropdown-icon select2'");  
                                                   ?>
            ...
            <?php
				...
				Hrs:
                           <?php
				 $start_arr = explode(':',$rule->flight_dep_time_start);
				...
				<div class="col-sm-3">
					Mins:
		<?php
		                                    echo form_dropdown("flight_dep_start_mins", $mins,set_value("flight_dep_start_mins",$start_arr[1]), "id='flight_dep_start_mins' class='form-control hide-dropdown-icon select2'");
		...
		?>
				...
				Hrs:
                           <?php
				$end_arr = explode(':',$rule->flight_dep_time_end);
...
<?php
			...
			$action_type_list['0'] = 'Select Action Type';
                        foreach ($action_types as $type) {
                         ...
                         echo form_dropdown("action_type", $action_type_list,set_value("action_type",$rule->action_type), "id='action_type' class='form-control hide-dropdown-icon select2'");
					   ...
					   <label for="future_use" class="col-sm-2 control-label">
                        ...
                        <div class="col-sm-6">
                            <?php 
							  $toggle[1] = "Yes";
							  $toggle[0] = "No";
							  echo form_dropdown("future_use", $toggle,set_value("future_use",$rule->future_use), "id='future_use' class='form-control hide-dropdown-icon'");
							?>
                        </div>
						<span class="col-sm-4 control-label">
...
$(document).ready(function(){
 var freq = [<?php echo $rule->frequency;?>];
