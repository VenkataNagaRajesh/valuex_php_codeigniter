...
/*@font-face { font-family: 'Siyam Rupali';
    ...
    *{
      /*font-family:  Siyamrupali, DejaVu Sans, firefly, Siyamrupali, verdana, sans-serif ; */
    ...
    <div id="page-wrap">
      ...
      <table class="table table-bordered">
        <tbody>
          ...
          <tr>
              <th width="40%"><?=$this->lang->line("profile_section")?></th>
              <td width="60%"><?php if(count($section)) { echo $section[$user->sectionID]; } ?></td>
          </tr>

          <tr>
              <th width="40%"><?=$this->lang->line("profile_dob")?></th>
                <td width="60%">
                  <?php if($user->dob) { echo date("d M Y", strtotime($user->dob)); } ?>
                </td>
          </tr>

          <tr>
              <th width="40%"><?=$this->lang->line("profile_sex")?></th>
              <td width="60%"><?php  echo $user->sex; ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$this->lang->line("profile_bloodgroup")?></th>
              <td width="60%"><?php if(isset($allbloodgroup[$user->bloodgroup])) { echo $user->bloodgroup; } ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$this->lang->line("profile_religion")?></th>
              <td width="60%"><?php  echo $user->religion; ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$this->lang->line("profile_email")?></th>
              <td width="60%"><?php  echo $user->email; ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$this->lang->line("profile_phone")?></th>
          ...
          <tr>
              <th width="40%"><?=$this->lang->line("profile_state")?></th>
              <td width="60%"><?php echo $user->state; ?></td>
          </tr>
          <tr>
          ...
          <tr>
              <th width="40%"><?=$this->lang->line("profile_father_profession")?></th>
              <td width="60%"><?php echo $user->father_profession ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$this->lang->line("profile_mother_name")?></th>
              <td width="60%"><?php  echo $user->mother_name; ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$this->lang->line("profile_mother_profession")?></th>
              <td width="60%"><?php  echo $user->mother_profession; ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$this->lang->line("profile_phone")?></th>
              <td width="60%"><?php  echo $user->phone; ?></td>
          ...
          <tr>
              <th width="40%"><?=$this->lang->line("profile_jod")?></th>
                <td width="60%">
                  <?php if($user->jod) { echo date("d M Y", strtotime($user->jod)); } ?>
                </td>
          </tr>
