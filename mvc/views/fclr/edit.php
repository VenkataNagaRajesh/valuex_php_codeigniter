...
<div class="box">
    ...
    <div class="box-body">
        <div class="row">
			...
			ksort($airports);
                          echo form_dropdown("board_point", $airports,set_value("board_point",$fclr->boarding_point), "id='board_point' class='form-control hide-dropdown-icon select2'");
                                                   ?>
			...
			$airports['0'] = 'Select Off Point';
                        ksort($airports);
                          echo form_dropdown("off_point", $airports,set_value("off_point",$fclr->off_point), "id='off_point' class='form-control hide-dropdown-icon select2'");
                                                   ?>
			...
			<?php 
			 ...
			 ksort($seasons);
			  echo form_dropdown("season_id", $seasons,set_value("season_id",$fclr->season_id), "id='season_id' class='form-control hide-dropdown-icon select2'");  
                                                   ?>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="departure_date" name="departure_date" value="<?=set_value('departure_date',date('d-m-Y',$fclr->departure_date))?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <?php
                         ...
                         ksort($carrier);
                          echo form_dropdown("carrier_code", $carrier,set_value("carrier_code",$fclr->carrier_code), "id='carrier_code' class='form-control hide-dropdown-icon select2'");
                                                   ?>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="flight_number" name="flight_number" value="<?=set_value('flight_number',$fclr->flight_number)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
...
<?php
			...
			ksort($days);
		 echo form_dropdown("frequency", $days, set_value("frequency",$fclr->frequency), "id='frequency' class='form-control hide-dropdown-icon select2'");
...
<?php
			...
			ksort($cabins);
                         echo form_dropdown("upgrade_from_cabin_type", $cabins,set_value("upgrade_from_cabin_type",$fclr->from_cabin), "id='upgrade_from_cabin_type' class='form-control hide-dropdown-icon select2'");
...
<?php
			...
			ksort($cabins);
                         echo form_dropdown("upgrade_to_cabin_type", $cabins,set_value("upgrade_to_cabin_type",$fclr->to_cabin), "id='upgrade_to_cabin_type' class='form-control hide-dropdown-icon select2'");
     ...
     ?>                   </div>
		 ...
		 <?php
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="min" name="min" value="<?=set_value('min',$fclr->min)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
 ...
 <?php
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="max" name="max" value="<?=set_value('max',$fclr->max)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
 ...
 <?php
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="avg" name="avg" value="<?=set_value('avg',$fclr->average)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
 ...
 <?php
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="slider_start" name="slider_start" value="<?=set_value('slider_start',$fclr->slider_start)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("edit_rule")?>" >
                        </div>
                    </div>
                </form>
            </div>
