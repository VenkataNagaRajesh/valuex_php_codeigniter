...
<div class="box">
    <div class="box-header" style="width:100%;">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_add')?> <?=$this->lang->line('menu_partner')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
            ...
            <div class="col-sm-8">
                <form class="form-horizontal" partner="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                        <?php
                        echo form_dropdown("origin_level", $aln_datatypes, set_value("origin_level"), "id='origin_level' class='form-control select2'");
                        ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                        <?php
                        echo form_dropdown("dest_level", $aln_datatypes, set_value("dest_level"), "id='dest_level' class='form-control select2'");
                        ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_partner")?>" >
                        </div>
                    </div>
