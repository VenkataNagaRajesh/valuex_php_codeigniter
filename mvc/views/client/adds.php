                   ...
                   <?php
					   ...
					   <label for="active" class="col-sm-2 control-label">
                        ...
                        <div class="col-sm-6">
                            <?php 
							  ...
							  echo form_dropdown("active", $status,set_value("active",1), "id='active' class='form-control hide-dropdown-icon select2'");
							?>
                        </div>
						<span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_client")?>" >
                        </div>
                    </div>
