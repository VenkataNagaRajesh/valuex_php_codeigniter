...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?=base_url("preference/index")?>"></i> <?php //echo$this->lang->line('menu_preference');?>Back</a></li>
            ...
            <div class="col-sm-8">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                           <input type="text" class="form-control" id="pref_code" name="pref_code" value="<?=set_value('pref_code')?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                           <input type="text" class="form-control" id="pref_display_name" name="pref_display_name" value="<?=set_value('pref_display_name')?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                           <input type="text" class="form-control" id="pref_value" name="pref_value" value="<?=set_value('pref_value',1)?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
						   ...
						   echo form_dropdown("pref_get_value_type", $valuetypelist,set_value("pref_get_value_type"), "id='pref_get_value_type' class='form-control hide-dropdown-icon select2'"); 
						   ?>
                        </div>
                        <span class="col-sm-4 control-label">
