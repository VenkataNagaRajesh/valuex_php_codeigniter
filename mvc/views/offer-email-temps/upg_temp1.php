      ...
      <td class="movableContentContainer">
																			...
																			<tbody>
																				<tr>
																					<td align="left" valign="middle">
																						<div class="contentEditableContainer contentImageEditable">
																							<div class="contentEditable">
																								<img alt="Company logo" data-default="placeholder" data-max-width="300" height="auto" src="../assets/mail-temps/upg_temp1_img/images/crenva.png" width="107" /></div>
																						</div>
																					</td>
																					...
																					<td align="right" valign="top" width="18">
																						<div class="contentEditableContainer contentImageEditable" style="display:inline-block;">
																							<div class="contentEditable">
																								<a target='_blank' href="[SHOWEMAIL]"><img alt="open in browser image" data-default="placeholder" height="15" src="../assets/mail-temps/upg_temp1_img/images/openBrowser.png" style="padding-left:10px;" width="15" /></a></div>
																						</div>
																					</td>
																				</tr>
																			</tbody>
        	...
        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
																...
																<tr>
																	<td align="center" bgcolor="#52619E" height="184" style="background:url('imgs/bigImg.png') #52619E no-repeat;background-size:560px 184px;" valign="middle" width="560">
																		<div class="contentEditableContainer contentImageEditable">
																			<div class="contentEditable">
																				<img class="banner" alt="product image" data-default="placeholder" data-max-width="560" height="300" src="../assets/mail-temps/upg_temp1_img/images/bg1.jpg" width="560" /></div>
																		</div>
																	</td>
																</tr>
															</table>
        ...
        <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
																									...
																									<tr>
																										<td align="left" valign="top">
																											<div class="contentEditableContainer contentTextEditable">
																												...
																												<div class="contentEditable" style="color:#fff;padding: 20px;background-image: url('../assets/mail-temps/upg_temp1_img/images/tag.png');right: 0;position: relative;width: auto;text-align: center;background-size: contain;background-position: center;background-repeat: no-repeat;">
																								...
																								<tbody>
																									...
																									<tr>
																										...
																										<td width="251" align="center" valign="middle">
																											<div class="contentEditableContainer contentImageEditable">
																												<div class="contentEditable">
																													<img alt="product image" data-default="placeholder" data-max-width="251" height="142" src="../assets/mail-temps/upg_temp1_img/images/upgrade-bg.JPG" width="251" /></div>
																											</div>
																										</td>
																										<td width="9">
																										</td>
																								...
																								<tbody>
																									...
																									<tr>
																										...
																										<td width="251" align="center" valign="middle">
																											<div class="contentEditableContainer contentImageEditable">
																												<div class="contentEditable">
																													<img alt="product image" data-default="placeholder" data-max-width="251" height="142" src="../assets/mail-temps/upg_temp1_img/images/upgrd-bg2.JPG" width="251" /></div>
																											</div>
																										</td>
																										<td width="9">
																										</td>
        	...
        	<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
																...
																<tr>
																	<td bgcolor="#fff" style="border:solid 1px #333;">
																		<table align="center" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tbody>
																				<tr>
																					<td align="left" bgcolor="#fff" valign="middle" width="416">
																						<table align="center" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" width="100%">
																							<tbody>
																								<tr>
																									<td width="30">
																									...
																									<td valign="middle">
																										<div class="contentEditableContainer contentTextEditable">
																											<div class="contentEditable">
																												<p style="color:#333;font-size:14px;line-height:19px;">
																													Stay in Touch!</p>
																											</div>
																										</div>
																									</td>
																					...
																					<td align="center" bgcolor="#0b0b5f" valign="top" width="50">
																						<table align="center" bgcolor="#0b0b5f" border="0" cellpadding="0" cellspacing="0" width="100%">
																							<tbody>
																								<tr>
																									<td align="center" bgcolor="#0b0b5f" height="50" valign="middle" width="50">
																										<div class="contentEditableContainer contentFacebookEditable">
																											<div class="contentEditable" valign="middle">
																												<a target='_blank' href=""><img alt="facebook link" data-default="placeholder" data-max-width="37" height="37" src="../assets/mail-temps/upg_temp1_img/images/facebook.png" width="37" data-customIcon="true" /></a></div>
																										</div>
																									</td>
																								</tr>
																							</tbody>
																					...
																					<td align="center" bgcolor="#12a4c3" valign="top" width="50">
																						<table align="center" bgcolor="#12a4c3" border="0" cellpadding="0" cellspacing="0" height="50" width="100%">
																							<tbody>
																								<tr>
																									<td align="center" bgcolor="#12a4c3" height="50" valign="middle" width="50">
																										<div class="contentEditableContainer contentTwitterEditable">
																											<div class="contentEditable" valign="middle">
																												<a target='_blank' href=""><img alt="twitter link" data-default="placeholder" data-max-width="37" height="37" src="../assets/mail-temps/upg_temp1_img/images/twitter.png" width="37" data-customIcon="true" /></a></div>
																										</div>
																									</td>
																								</tr>
																							</tbody>
