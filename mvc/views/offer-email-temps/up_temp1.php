        	...
        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
																...
																<tr>
																	<td align="center" bgcolor="#52619E" height="184" style="background-size:560px 184px;" valign="middle" width="560">
																		<div class="contentEditableContainer contentImageEditable">
																			<div class="contentEditable">
																				<img class="banner" alt="product image" data-default="placeholder" data-max-width="560" height="300" src="{up_tpl1_bnr}" width="560" /></div>
																		</div>
																	</td>
																</tr>
															</table>
								...
								<tr>
									<div style="font-weight:500;position: relative;min-height: 1px;overflow: auto;width:100%;font-family:calibri;border-bottom:solid 1px #ddd;padding-bottom:10px;" class="hidden-lg hidden-sm hidden-md">
										<div style="width:100%;text-align:center;">
											 <p style="color:#333;"><b>{from_city_code} - {to_city_code} | {dep_date}, {dep_time} hrs</b></p>
										</div>
									</div>	
								</tr>
																								...
																								<tbody>
																									...
																									<tr>
																										...
																										<td width="251" align="center" valign="middle">
																											<div class="contentEditableContainer contentImageEditable">
																												<div class="contentEditable">
																													<img alt="product image" data-default="placeholder" data-max-width="251" height="142" src="{up_tpl1_rgt_img}" width="251" /></div>
																											</div>
																										</td>
																										<td width="9">
																										</td>
																								...
																								<tbody>
																									...
																									<tr>
																										...
																										<td width="251" align="center" valign="middle">
																											<div class="contentEditableContainer contentImageEditable">
																												<div class="contentEditable">
																													<img alt="product image" data-default="placeholder" data-max-width="251" height="142" src="{up_tpl1_lft_img}" width="251" /></div>
																											</div>
																										</td>
																										<td width="9">
																										</td>
																								...
																								<tr>
																									<td align="center" bgcolor="#12a4c3" height="50" valign="middle" width="50">
																										<div class="contentEditableContainer contentTwitterEditable">
																											<div class="contentEditable" valign="middle">
																												<a href="twitter_link" target='_blank' href=""><img alt="twitter link" data-default="placeholder" data-max-width="37" height="37" src="{twitter_icon}" width="37" data-customIcon="true" /></a></div>
																										</div>
																									</td>
																								</tr>
																							</tbody>
