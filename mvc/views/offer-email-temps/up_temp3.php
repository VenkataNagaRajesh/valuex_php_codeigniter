    ...
    <tr>
      <td valign="top" width="340" class="specbundle2"><div class="contentEditableContainer contentImageEditable">
                              <div class="contentEditable" >
                                <img width="150" src="{airline_logo}" data-max-width="340" alt='{carrier_name}'>
                              </div>
                            </div></td>
                    ...
                    <tr>
                      <td bgcolor='#B57801'>
                        <div class="contentEditableContainer contentImageEditable">
                          <div class="contentEditable" >
                            <img class="banner" src="{up_tpl3_bnr}" data-default="placeholder" data-max-width="600" width='600' alt='{carrier_name}' border="0">
                          </div>
                        </div>
                      </td>
                    </tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <td align='center'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div style='font-size:13px;font-weight:bold;' class="contentEditable" >
                                  <p style="color:#333;">Sent to {primary_mail} by {carrier_name} | {primary_phone} </p>
                                </div>
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            <td align='center' style='font-size:13px;'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable" >
                                  <p style='color:#999999;'><a target='_blank' href='{domain}' class='link2'>Home</a> | <a target='_blank' href="{openbrowser_link}" class='link2'> Open in browser </a> | <a target='_blank' href="{forward_friend_link}" class='link2'>Forward to a friend</a> | <a target='_blank' href='{unsubscribe_link}' class='link2'>Unsubscribe</a></p>
                                </div>
                              </div>
                            </td>
                          </tr>
