                    ...
                    <tr>
                      <td bgcolor='#B57801'>
                        <div class="contentEditableContainer contentImageEditable">
                          <div class="contentEditable" >
                            <img class="banner" src="{up_tpl2_bnr}" data-default="placeholder" data-max-width="600" width='600' alt='Happy New Year!' border="0">
                          </div>
                        </div>
                      </td>
                    </tr>
                            ...
                            <td align='center'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div style='font-size:13px;font-weight:bold;' class="contentEditable" >
                                  <p style='color:#999999;'>Sent to {primary_mail} by {carrier_name} | {primary_phone} </p>
                                </div>
                              </div>
                            </td>
                          </tr>
