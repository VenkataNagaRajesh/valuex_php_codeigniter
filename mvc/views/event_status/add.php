<div class="box">
    <div class="box-header" style="width:100%;">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('add_event_status')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
        <div class="row">
		 ...
		 <?php
			...
			ksort($booking_status);
                        echo form_dropdown("event_id", $booking_status, set_value("event_id"), "id='event_id' class='form-control select2'");
                        ?>
                        </div>
			...
			<?php 
			 $booking_status['0'] = 'Select Current Status';
                        ksort($booking_status);
                        echo form_dropdown("current_status", $booking_status, set_value("current_status"), "id='current_status' class='form-control select2'");
			...
			?>
				...
				ksort($booking_status);
				echo form_multiselect("next_status[]", $booking_status, set_value("next_status"), "id='next_status' class='form-control select2'");
?>                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                                          $toggle[1] = "Yes";
                                                          $toggle[0] = "No";
                                                          echo form_dropdown("isInternalStatus", $toggle,set_value("isInternalStatus",1), "id='isInternalStatus' class='form-control hide-dropdown-icon'");
                                                        ?>
                        </div>
                                                <span class="col-sm-4 control-label">
