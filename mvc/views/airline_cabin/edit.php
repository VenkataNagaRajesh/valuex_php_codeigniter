...
?>
                    ...
                    ?>
                        <label for="cabin_seat_capacity" class="col-sm-2 control-label">
                            <?=$this->lang->line("airline_cabin_seat_capacity")?> <span class="text-red">*</span>
			</label>

                        <div class="col-sm-6">
                            <input type="text" class="form-control" id=cabin_seat_capacity" name="cabin_seat_capacity" value="<?=set_value('cabin_seat_capacity', $airline->cabin_seat_capacity)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
