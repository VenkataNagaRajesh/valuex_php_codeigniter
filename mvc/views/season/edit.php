            ...
            <div class="col-sm-8">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="season_name" name="season_name" value="<?=set_value('season_name',$season->season_name)?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="ams_season_start_date" name="ams_season_start_date" value="<?=set_value('ams_season_start_date',date('d-m-Y',$season->ams_season_start_date))?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="ams_season_end_date" name="ams_season_end_date" value="<?=set_value('ams_season_end_date',date('d-m-Y',$season->ams_season_end_date))?>" >
                        </div>
                        <span class="col-sm-4 control-label">
					   ...
					   <label for="is_return_inclusive" class="col-sm-2 control-label">
                        ...
                        <div class="col-sm-6">
                            <?php 
							  $toggle[1] = "Yes";
							  $toggle[0] = "No";
							  echo form_dropdown("is_return_inclusive", $toggle,set_value("is_return_inclusive",$season->is_return_inclusive), "id='is_return_inclusive' class='form-control hide-dropdown-icon'");
							?>
                        </div>
						<span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="season_color" name="season_color" value="<?=set_value('season_color',$season->season_color)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
					   ...
					   <label for="active" class="col-sm-2 control-label">
                        ...
                        <div class="col-sm-6">
                            <?php 
							  ...
							  echo form_dropdown("active", $status,set_value("active",$season->active), "id='active' class='form-control hide-dropdown-icon'");
							?>
                        </div>
						<span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("update_season")?>" >
                        </div>
                    </div>
                </form>
            </div>
...
$(document).ready(function(){
	...
	console.log(<?php echo $season->ams_orig_level_value; ?>);
	var orig_level = [<?php echo $season->ams_orig_level_value; ?>];
	$('#ams_orig_level_value').val(orig_level).trigger('change');
	var dest_level = [<?php echo $season->ams_dest_level_value; ?>];
