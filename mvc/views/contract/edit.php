                    ...
                    <label for="products" class="col-sm-4 control-label">
                        ...
                        <div class="col-sm-8">
                           <!-- <select name="products[]" id="products" class="form-control select2" multiple="multiple"> -->				 
                            <?php 
                             echo form_dropdown("pmod$i-productID", $productslist, set_value("pmod".$i."-productID",$contract->products[$i-1]->productID), "id='pmod$i-productID' class='form-control hide-dropdown-icon'");                               
                            ?>
                          <!--  </select> -->  
                            <span class="control-label">
   ...
   $("#pmod<?=$i?>-productID").select2();
    $("#pmod<?=$i?>-start-date").datepicker({    
        onSelect: function(dateText) {
            ...
            $("#pmod<?=$i?>-end-date").datepicker("setDate", new Date(dateinfo[2],dateinfo[0],dateinfo[1]) );
        }
    });
