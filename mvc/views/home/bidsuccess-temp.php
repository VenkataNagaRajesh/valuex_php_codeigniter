...
<div style="width:1170px;margin-right: auto;margin-left: auto;padding-left: 15px;padding-right: 15px;font-family:century gothic;">
	<div>
		...
		<div style="width: 1170px;min-height: 1px;padding-left: 15px;padding-right: 15px;">
			<div style="background: #f5f5f5;height: 38px;margin: 16px 0;"></div>
		</div>
	</div>
	<div>
		<div style="width: 1170px;position: relative;min-height: 1px;padding-left: 15px;padding-right: 15px;float:left;">
			<div>
