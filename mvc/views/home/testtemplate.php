        ...
        <div>
                <div style="border: solid 1px #333;margin-top:20px;margin-left: 16.66667%;width: 66.66667%;">
                        <div style="position: relative;min-height: 1px;padding-left: 15px;padding-right: 15px;">
                                <div style="background-image: url({base_url}assets/home/images/temp1-hdr-bg.jpg);margin-top: 20px;">
                        ...
                        <div style="position: relative;min-height: 1px;padding-left: 15px;padding-right:15px;">		      
                                ...
                                <p style="text-align:center;"><a type="button" href="{base_url}home/index?pnr_ref={pnr_ref}" style="background: #ff6633;font-weight:bold;padding:8px 26px;font-size: 23px;border-radius: 33px;border:none;color:#fff;font-family:century gothic;text-decoration:none;">BID NOW</a></p>
                                <div class="info">
                                        <p style="margin-bottom: 10px;font-size: 14px;color: #333;font-family: century gothic;text-align:center;">
