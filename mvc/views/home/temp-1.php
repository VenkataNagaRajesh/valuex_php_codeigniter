...
<body>
<div style="min-width: 245px;max-width: 1100px;position: relative;padding: 10px;margin:0 auto;border: solid 1px #ddd;" border="0">
	<div style="margin-left:auto;margin-right:auto;width:100%;background: {mail_header_color};">
		<img style="width:120px;vertical-align: middle;" src="{logo}" alt="logo" width="120">
	</div>
	<div>
		<div style="position: relative;min-height: 1px;">
			<div class="mobile" style="background-repeat: no-repeat;width: 100%;background-size: cover;">
				<p style="margin:8px 0;color: #333;font-size: 16px;font-weight: bold;font-family:calibri;"><span color="blue">Hi {first_name}! </span><span style="float: right;color:#333;"> &nbsp;&nbsp;&nbsp;&nbsp;Booking Reference : {pnr_ref}</span></p>
			</div>
			<div>
		...
		<br>
		<div style="font-weight:500;position: relative;min-height: 1px;overflow: auto;width:100%;margin-bottom: 20px;font-family:calibri;" class="hidden-xs">
