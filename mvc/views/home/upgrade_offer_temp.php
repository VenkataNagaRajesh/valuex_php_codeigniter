                ...
                <div class="col-md-12">
                        <div class="col-md-2">
                               <!-- <img style="width:100px;" src="{base_url}assets/home/images/emir.png" alt="logo">-->
                                <img style="width:100px;" src="cid:{logo_cid}" alt="photo1" />
                        </div>
                </div>
        </div>
</div>
        ...
        <div>
                <div style="border: solid 1px #333;margin-top:20px;margin-left: 16.66667%;width: 66.66667%;">
                        <div style="position: relative;min-height: 1px;padding-left: 15px;padding-right: 15px;">
                                <div style="background-image: url(cid:{bgr_file});margin-top: 20px;">
                                ...
                                <div>
                                        <img style="width:auto;display: block;max-width: 100%;height:auto;" src="cid:{temp_cid}" alt="temp bnr">
                                </div>
                        </div>
                        <div style="position: relative;min-height: 1px;padding-left: 15px;padding-right:15px;">
...
<p style="text-align:center;"><a type="button" href='https://bit.ly/2MdLdlR' style="background: #ff6633;font-weight:bold;padding:8px 26px;font-size: 23px;border-radius: 33px;border:none;color:#fff;font-family:century gothic;text-decoration:none;">BID NOW</a></p>
